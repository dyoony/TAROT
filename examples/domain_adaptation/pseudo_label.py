...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(classifier.state_dict(), logger.get_checkpoint_path(epoch))
        estimator = LipschitzEstimator(classifier, epsilon=8/255, n_steps=10, step_size_factor=4, device=device)
