...
import time
import math
from .other_utils import Logger, InputNormalize
    ...
    def run_standard_evaluation(self, x_orig, y_orig, bs=250):
        ...
        with torch.no_grad():
            ...
            for batch_idx in range(n_batches):
                ...
                output = self.get_logits(self.normalizer(x))
            ...
            #print(x_adv.shape)=[32, 3, 224, 224]
            ...
            for attack in self.attacks_to_run:
                ...
                for batch_idx in range(n_batches):
                    ...
                    if attack == 'apgd-ce':
                        ...
                        #print("diff is" + str((adv_curr - x).max()))=0
                    ...
                    output = self.get_logits(self.normalizer(adv_curr))
